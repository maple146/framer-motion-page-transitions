...
export default function BottomLeftContent({ setTransition }: setTransitionTypes) {
    return (
        <div className="bg-slate-800 h-[500px] w-[500px] flex flex-col justify-center items-center">
            <h1 className="text-white mb-2">Bottom left section content</h1>
            <button
